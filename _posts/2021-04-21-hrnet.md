...
实验表明`HRNet`对提升物体检测、分割、姿态估计准确性方面具有显著优势，更广阔的意义是能作为一个通用的$\textcolor{red}{骨干网}$，应用在各项视觉任务上。

### High-Resolution Networks
1. HRNetV1 for pose estimation
2. HRNetV2 for semantic segmentation
3. HRNetV2p for object detection
...
上图 HRNet 示例，只显示了主体部分，不包括2个 stride=2 的3x3卷积  
